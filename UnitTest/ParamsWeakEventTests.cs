...
public sealed class ParamsWeakEventTests
{
    [Fact]
    public void Add_MultipleHandlers_AllHandlersShouldBeInvoked()
    {
        ...
        publisher.ParamsWeakEvent += subscriber1.EventHandler;
        publisher.ParamsWeakEvent += subscriber1.SecondEventHandler;
        publisher.ParamsWeakEvent += subscriber2.EventHandler;
        publisher.ParamsWeakEvent += Subscriber.StaticEventHandler;
        publisher.ParamsWeakEvent += Subscriber.SecondStaticEventHandler;

        publisher.RaiseParamsWeakEvent();
    ...
    public void Remove_SingleHandler_HandlerShouldNotBeInvoked()
    {
        ...
        publisher.ParamsWeakEvent += subscriber1.EventHandler;
        publisher.ParamsWeakEvent += subscriber2.SecondEventHandler;
        publisher.ParamsWeakEvent += subscriber1.SecondEventHandler;
        publisher.ParamsWeakEvent += subscriber2.EventHandler;
        publisher.RaiseParamsWeakEvent();
    ...
    [Fact]
    public void LeakPrevention_SubscriberToParamsWeakEvent_ShouldBeCollected()
    {
        // Arrange
        static WeakReference<Subscriber> Subscribe(Publisher publisher)
        {
            Subscriber subscriber = new();
            publisher.ParamsWeakEvent += subscriber.EventHandler;
